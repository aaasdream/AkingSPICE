...
class ExplicitStateSolver {
    ...
    updateStateVariables() {
        ...
        for (let i = 0; i < stateCount; i++) {
            ...
            // 只處理電容(C)和電感(L)
            if (component && (component.type === 'C' || component.type === 'L')) ; else {
                continue; // 不是電容或電感，跳過
            }
...
export { AkingSPICE, BaseComponent, CCCS, CCVS, Capacitor, CoupledInductor, CurrentSource, DCAnalysis, Diode, ExplicitStateSolver, GPUExplicitStateSolver, Inductor, MOSFET, MultiWindingTransformer, NetlistParser, Resistor, ThreePhaseSource, TransientAnalysis, VCCS, VCVS, VoltageControlledMOSFET, VoltageSource, AkingSPICE as default };
